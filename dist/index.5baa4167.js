...
class Clock {
    ...
    intializeClock() {
        ...
        <line class="hand hand--second" x1="0" y1="2" x2="0" y2="-135"/>
        
        </svg>`;
        this.UI.date = this.clockEl.querySelector(".date"), this.UI.am_pm = this.clockEl.querySelector(".am-pm"), this.UI.second = this.clockEl.querySelector(".hand--second"), this.UI.minute = this.clockEl.querySelector(".hand--minute"), this.UI.hour = this.clockEl.querySelector(".hand--hour"), requestAnimationFrame(this.updateClock);
    }
}
...
},{"../_lib/tzParseTimezone/index.js":"kzqA4","../toDate/index.js":"lwKwP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["adBpN","igcvL"], "igcvL", "parcelRequireb13b")
